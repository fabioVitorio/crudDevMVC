...
<body>
  ...
  <nav class="navbar bg-dark border-bottom border-body p-1">
    <div class="container-fluid">
      ...
      <h4 class="text-center text-light m-0">ATUALIZAR ALUNO</h4>
  ...
  <div style="padding: 0px 0 20px 0; max-width: 60%; margin: 0 auto">
    <form method="POST" action="http://localhost/crudDev/User/editarAluno" class="row justify-content-center g-2 m-auto needs-validation" style="padding: 30px; " novalidate>
      <div>
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="name" name="nome" value="{{ aluno.nome }}" aria-describedby="inputGroupPrepend" placeholder="Digite o nome" required>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="input-group has-validation">
          ...
          <input type="email" class="form-control" name="email" value="{{ aluno.email }}" aria-describedby="inputGroupPrepend" placeholder="Digite o e-mail" required>
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="inputCpf" name="cpf" value="{{ aluno.cpf }}" aria-describedby="inputGroupPrepend" placeholder="Digite o CPF" required>
          <script>
            document.addEventListener('DOMContentLoaded', function() {
              new Cleave('#inputCpf', {
                delimiters: ['.', '.', '-'],
      ...
      <div class="col-md-6">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" name="matricula" value="{{ aluno.matricula }}" readonly aria-describedby="inputGroupPrepend" style="color: gray">
        </div>
      </div>
          ...
          <div class="col-md-3">
            ...
            <div class="input-group has-validation">
              ...
              <select class="form-select" name="acesso" required>
                ...
                <option value="Sim" {% if aluno.acesso == 'Sim' %}selected{% endif %}>Sim</option>
                <option value="Não" {% if aluno.acesso == 'Não' %}selected{% endif %}>Não</option>
              </select>
            </div>
          </div>
      </div>
